...
"""
acclaim-badges documentation build configuration file.
...
project = 'acclaim-badges'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Acclaim Badges'
...
#
# html_title = 'acclaim-badges v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Acclaim Badges for EDX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'acclaim_badges'),
                os.path.join(root_path, 'acclaim_badges/migrations')])
